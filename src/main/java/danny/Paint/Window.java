...
class Window
{
	...
	Window()
	{
		...
		window.setIconImage(new ImageIcon(Window.class.getResource("../../colorpalette.png")).getImage());
		...
		layout.setVerticalGroup(layout.createSequentialGroup()
				.addComponent(paintToolbar, 60,
						60, 60)
				.addComponent(canvas, GroupLayout.PREFERRED_SIZE,
